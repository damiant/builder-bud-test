    ...
    <div className="header-sticky-wrapper">
      <header className="main-header">
        <div className="header-left">
          ...
          <div className="menu-text-button" onClick={toggleMenu} role="button" tabIndex={0}>
            Main Menu
          </div>
        </div>
      ...
      <div className={`mega-menu-overlay ${isMenuOpen ? 'open' : ''}`}>
        <div className="mega-menu-content">
          <div className="vertical-menu">
            ...
            <a
              href="https://www.anheuser-busch.com/renewable-electricity"
            ...
            <div className="beer-grid">
              <div className="beer-item">
                <a href="https://us.budweiser.com/budweiser" className="beer-link">
                  <img
                    alt="Budweiser"
                    loading="lazy"
                    src="https://cdn.builder.io/api/v1/image/assets%2F2c2f396d58f344ecaa467593ed0ec411%2Fb0d1af3c504a49289a8676b636dd1871"
                    className="beer-img"
                  />
              ...
              <div className="beer-item">
                <a href="https://us.budweiser.com/budweiser-zero" className="beer-link">
                  <img
                    alt="Budweiser Zero"
                    loading="lazy"
                    src="https://cdn.builder.io/api/v1/image/assets%2F2c2f396d58f344ecaa467593ed0ec411%2F7e03aec2a33546b7a18ea244873e8542"
                    className="beer-img"
                  />
              ...
              <div className="beer-item">
                <a href="https://us.budweiser.com/budweiser-select" className="beer-link">
                  <img
                    alt="Budweiser Select"
                    loading="lazy"
                    src="https://cdn.builder.io/api/v1/image/assets%2F2c2f396d58f344ecaa467593ed0ec411%2Fe7632f4337d849b9b90bf1c447bc96b5"
                    className="beer-img"
                  />
              ...
              <div className="beer-item">
                <a href="https://us.budweiser.com/budweiser-select-55" className="beer-link">
                  <img
                    alt="Budweiser Select 55"
                    loading="lazy"
                    src="https://cdn.builder.io/api/v1/image/assets%2F2c2f396d58f344ecaa467593ed0ec411%2F5ebe2e9a0e1f4b9fab5bee8ee3272127"
                    className="beer-img"
                  />
              ...
              <div className="beer-item">
                <a href="https://us.budweiser.com/budweiser-chelada" className="beer-link">
                  <img
                    alt="Budweiser Chelada"
                    loading="lazy"
                    src="https://cdn.builder.io/api/v1/image/assets%2F2c2f396d58f344ecaa467593ed0ec411%2Fcc8e40798b694c239fa79ab519534d8a"
                    className="beer-img"
                  />
